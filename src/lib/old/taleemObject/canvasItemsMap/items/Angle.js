...
export default class Angle {
  ...
  static isHit(itemExtra, mouseX, mouseY) {
    ...
    return distanceSq <= itemExtra.radius * itemExtra.radius; // Clickable inside full circle
  }



  static boundingRectangleX(itemExtra) {
    return itemExtra.x - itemExtra.radius - 10;
  }

  static boundingRectangleY(itemExtra) {
    return itemExtra.y - itemExtra.radius - 10;
  }

  static width(itemExtra) {
    return (itemExtra.radius + 10) * 2;
  }
  ...
  static setWidth(itemExtra, newWidth) {
    itemExtra.radius = newWidth / 2 - 10;
  }

  static setHeight(itemExtra, newHeight) {
    itemExtra.radius = newHeight / 2 - 10;
  }
